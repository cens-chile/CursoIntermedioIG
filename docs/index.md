...
```json
{
  ...
  "id" : "fhir.example.curso",
  "url" : "http://example.org/curso/ImplementationGuide/fhir.example.curso",
  "version" : "0.1.0",
  "name" : "CursoIG",
  "title" : "Este es el título de la guía en | R4",
  "status" : "draft",
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://example.org/curso/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "SearchParameter/birthPlace-extension"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/CoreClPatientDerivado"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/example-patient-profile"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/fecha-contacto"
        },
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/MiListaDeCodigosVS"
        },
        "name" : "Mi lista de Códigos",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/MiListaDeCodigosCS"
        },
        "name" : "Mi lista de Códigos",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Patient/PatientExampleCoreCl"
        },
        "name" : "PatientExampleCoreCl",
        "description" : "An example of a patient with a license to krill.",
        "exampleCanonical" : "http://example.org/curso/StructureDefinition/CoreClPatientDerivado"
      }
    ],
    "page" : {
      "extension" : [
      ...
      "page" : [
        ...
        },
        {
          "extension" : [
            {
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "casos_de_uso.html"
            }
          ],
          "nameUrl" : "casos_de_uso.html",
          "title" : "Casos De Uso",
          "generation" : "markdown"
        },
        {
