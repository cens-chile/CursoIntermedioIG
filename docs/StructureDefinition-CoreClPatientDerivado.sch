...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:telecom">
      <sch:assert test="count(f:extension[@url = 'http://example.org/curso/StructureDefinition/fecha-contacto']) &gt;= 1">extension with URL = 'http://example.org/curso/StructureDefinition/fecha-contacto': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/curso/StructureDefinition/fecha-contacto']) &lt;= 1">extension with URL = 'http://example.org/curso/StructureDefinition/fecha-contacto': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/curso/StructureDefinition/fecha-contacto']) &gt;= 1">extension with URL = 'http://example.org/curso/StructureDefinition/fecha-contacto': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/curso/StructureDefinition/fecha-contacto']) &lt;= 1">extension with URL = 'http://example.org/curso/StructureDefinition/fecha-contacto': maximum cardinality of 'extension' is 1</sch:assert>
